...
export default function CanvasToolsFab({ fabricCanvas }: CanvasToolsFabProps) {
  const { addCircle, addImageFromFile, addLine, addPolygon, addRectangle, addText } =
    ...
    <Tooltip.Provider>
      ...
      >
        <div className='flex items-center gap-1.5 rounded-xl border border-[var(--wise-border)] bg-[var(--wise-surface-raised)]/95 p-1.5 shadow-[0_8px_20px_rgba(0,0,0,0.35)] backdrop-blur'>
          ...
          <ToolButton label='Add circle' onClick={addCircle} onMouseDown={onMouseDown}>
            <svg
              viewBox='0 0 24 24'
              className='size-4'
              fill='none'
          ...
          <ToolButton label='Add line' onClick={addLine} onMouseDown={onMouseDown}>
            <svg
              viewBox='0 0 24 24'
              className='size-4'
              fill='none'
