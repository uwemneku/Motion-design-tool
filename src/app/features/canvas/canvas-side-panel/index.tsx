...
export default function CanvasSidePanel() {
  ...
  return (
    <aside className="flex max-h-[34vh] w-full shrink-0 flex-col overflow-hidden border-t border-[var(--wise-border)] bg-[var(--wise-surface-raised)]/95 xl:h-full xl:max-h-none xl:w-72 xl:border-t-0 xl:border-l">
      <div className="sticky top-0 z-10 border-b border-[var(--wise-border)] bg-[var(--wise-surface-raised)]/95 p-2.5 xl:p-3">
        <div className="flex rounded-xl border border-[var(--wise-border)] bg-[var(--wise-surface)] p-1">
          <button
            type="button"
            onClick={() => {
              setActiveTab("design");
